...
## Project Structure
    ...
    ├── testapiautodatamod_108302  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_108302`
...
2. Clone this repo and `cd testapiautodatamod_108302`
